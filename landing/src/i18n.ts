...
export const t = {
  ...
  corpDesc: i("13 flavors across Chinese & Western companies — matched to failure modes for maximum precision.", "13 种风味，中西合璧，按失败模式选择最合适的施压风格。", "中国・欧米13社のフレーバー — 失敗パターンに合わせて最適な圧力スタイルを選択。", "13 saveurs d'entreprises chinoises et occidentales — adaptées aux modes d'échec.", "13 Varianten aus chinesischen & westlichen Unternehmen — auf Fehlermuster abgestimmt.", "13 أنماط من شركات صينية وغربية — مطابقة لأنماط الفشل لأقصى دقة."),
